        ...
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
                <a href="#top">
                    ...
                    <p className='font-bold text-3xl font-Ovo w-28 cursor-pointer mr-14'>Manis <span className='text-3xl text-lime-300 border-2 -ml-2'>h.</span></p>
                </a>
                ...
                <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4 py-10 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-darkHover dark:text-white'>
                    ...
                    <li><a onClick={closeMenu} className='font-Ovo' href="#projects">Projects</a></li>
